...
class Translator(object):
    ...
    def __init__(self, opt, model, model_opt):
        self.opt = opt
    ...
    def translate_batch(self, src_seq, src_pos, bos_token=1, eos_token=3, pad_token=0):
        ...
        with torch.no_grad():
            ...
            #-- Prepare beams
            inst_dec_beams = [Beam(n_bm, device=self.device, bos_token=bos_token,
                                   eos_token=eos_token, pad_token=pad_token) for _ in range(n_inst)]
