...
def main():
    ...
    if opt.save_model:
        en_vocab_name = opt.save_model + '_en.vocab'
        sql_vocab_name = opt.save_model + '_sql.vocab'
        torch.save(en_field.vocab, en_vocab_name)
        torch.save(sql_field.vocab, sql_vocab_name)
